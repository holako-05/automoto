...
return [
    ...
    'attributes'           => [
        ...
        'employe'               => 'الموظف',
        'first_name_fr'            => ' الاسم الشخصي بالحروف اللاتينية',
        'last_name_fr'            => 'الاسم العائلي بالحروف اللاتينية',
        'role'            => 'الدور',
        'gender'                => 'النوع',
        'hour'                  => 'ساعة',
        'last_name'             => 'الاسم العائلي',
        'cin'             => 'رقم البطاقة الوطنية',
        'rent_number'             => 'رقم التأجير',
        'mission'                => 'المهمة',
        'login'                => 'اسم المستخدم',
        'direction'                => 'الاتجاه من الرباط إلى',
        'escorts'                => 'المرافقون',
        'transport_means'                => 'وســـيلة النـــقـــل',
        'go_date'                => ' تاريخ الذهــــــــاب',
        'return_date'                => 'تاريخ الإيـــــــــاب',
        'return_time'                => 'على الساعة',
        'go_time'                => 'على الساعة',
        'distance'                => ' المسافة المأذون بها',
        'fuel_type'                => ' الوقـــــود المستعمــــــــل',
        'car_type'                => ' قـــــــــــــوة المحــــــرك',
        'car_model'                => ' نــــــــوع السيـــــــــــارة',
        'registration_number'                => ' رقم تسجــيـــل السيــــارة',
        'pension_number'             => 'رقم المعاش',
