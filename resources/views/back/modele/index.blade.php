...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success) {
                    ...
                    window.location.replace("/modele");
                } else {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('modele.data') }}",
            columns: [{data: '',}, {data:'marque_id', name:'marque_id'}, {data:'title', name:'title'}, {data:'value', name:'value'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('modele.create')}}';
                    }
                }
            ],
            responsive: {
