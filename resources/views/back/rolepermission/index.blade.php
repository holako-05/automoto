...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('rolepermission.data') }}",
            columns: [{data: '',}, {data:'role_id', name:'role_id'}, {data:'permission_id', name:'permission_id'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('rolepermission.create')}}';
                    }
                }
            ],
            responsive: {
