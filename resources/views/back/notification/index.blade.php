...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ...
            columns: [{data: '',}, {data:'title', name:'title'}, {data:'description', name:'description'}, {data:'link', name:'link'}, {data:'notified', name:'notified'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('notification.create')}}';
                    }
                }
            ],
            responsive: {
