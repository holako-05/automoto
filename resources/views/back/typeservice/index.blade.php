...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success) {
                    ...
                    window.location.replace("/typeservice");
                } else {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('typeservice.data') }}",
            columns: [{data: '',}, {data:'title', name:'title'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('typeservice.create')}}';
                    }
                }
            ],
            responsive: {
