...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('typeservice.store') }}">
            @csrf
            <div class="row g-3">
                   @can('typeservice.title.create')
   <div class="col-md-6">
       <label class="form-label" for="title">Nom de type</label>
       <input type="text" name="title" id="title" class="form-control" placeholder="Nom de type" value="{{ old('title') }}" />
       @error('title')
