...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="py-3 mb-4">Gestion des typeservices</h4>
        </div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('typeservice.index') }}">Liste des typeservices</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('typeservice.update', ['typeservice' => $record->id]) }}">
            @csrf
            @method('Put')
            <div class="row g-3">
                   @can('typeservice.title.update')
   <div class="col-md-6">
       <label class="form-label" for="title">Nom de type</label>
       <input type="text" name="title" id="title" class="form-control" placeholder="Nom de type" value="{{ old('title', $record->title) }}" />
       @error('title')
   ...
   @endcan
            ...
            <div class="pt-4 float-start">
                ...
                <a href="{{ route('typeservice.index') }}" class="btn btn-label-secondary">Retour</a>
            </div>
        </form>
    </div>
</div>
