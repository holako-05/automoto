...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('apparence_create') }}" id="formValidationUser">
            @csrf
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="title" id="title" class="form-control" placeholder="Libellé" value="{{ old('title') }}" />
                    @error('title')
                    <span class="helper-text text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="logo_titre" id="logo_titre" class="form-control" placeholder="Titre du Logo" value="{{ old('logo_titre') }}" />
                    @error('logo_titre')
                    <span class="helper-text text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="logo_home" id="logo_home" class="form-control" placeholder="Logo Accueil" value="{{ old('logo_home') }}" />
                    @error('logo_home')
                    <span class="helper-text text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="couleur_header" id="couleur_header" class="form-control" placeholder="Logo Accueil" value="{{ old('couleur_header') }}" />
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="couleur_sidebar" id="couleur_sidebar" class="form-control" placeholder="Logo Accueil" value="{{ old('couleur_sidebar') }}" />
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="couleur_sidebar_logo" id="couleur_sidebar_logo" class="form-control" placeholder="Couleur sidebar logo" value="{{ old('couleur_sidebar_logo') }}" />
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="couleur_menu_actif" id="couleur_menu_actif" class="form-control" placeholder="Couleur menu actif" value="{{ old('couleur_menu_actif') }}" />
