            ...
            <div class="row">
                ...
                <div class="col s12 m6 l6 right-align-md">
                    <ol class="breadcrumbs mb-0 mt-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('quickyproject.index')}}">Liste des
                                quickyprojects</a>
                        </li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col s12">
                                    ...
                                    <table id="list-datatable" class="table table-bordered table-striped">
                                        ...
                                        @foreach ($records as $record)
                                            <tr>
                                                ...
                                                <td> {{ $record->name }} </td>
                                                <td> {{ $record->id_project }} </td>
                                                <td>
                                                    <a href="{{route('quickyproject.edit', ['quickyproject'=>$record->id])}}"><i
            ...
            <div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top"><a
                    href="{{route('quickyproject.create')}}"
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.success) {
                        ...
                        window.location.replace("/quickyproject");
                    } else {
        ...
        $(document).ready(function () {
            ...
            $('#list-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('quickyproject.data') }}",
                columns: [{data: 'name', name: 'name'}, {data: 'id_project', name: 'id_project'}, {
                    data: 'action',
                    name: 'action',
                    orderable: false,
                    searchable: false
