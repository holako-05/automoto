    ...
    <div class="col s12">
        <div class="container">
            <div class="section">
                ...
                <form method="POST" action="{{route('quickyproject.update', ['quickyproject' => $record->id])}}">
                    @csrf
                    @method('PUT')
                    <br>
                        ...
                        <div class="row">
                                <div class="col s12 m12">
                                    <div class="row">
                                        ...
                                        <div class="col s12 input-field">
                                            <input id="id_project" name="id_project" value="{{old('id_project', $record->id_project)}}" autocomplete="off"
                                            readonly onfocus="this.removeAttribute('readonly');" type="text">
