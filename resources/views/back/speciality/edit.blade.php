...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="py-3 mb-4">Gestion des specialitys</h4>
        </div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('speciality.index') }}">Liste des specialitys</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('speciality.update', ['speciality' => $record->id]) }}">
            @csrf
            @method('Put')
            <div class="row g-3">
                   @can('speciality.label.update')
   <div class="col-md-6">
   ...
   @endcan   @can('speciality.description.update')
   <div class="col-md-6">
   ...
   @endcan
            ...
            <div class="pt-4 float-start">
                ...
                <a href="{{ route('speciality.index') }}" class="btn btn-label-secondary">Retour</a>
            </div>
        </form>
    </div>
</div>
