...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('speciality.data') }}",
            columns: [{data: '',}, {data:'label', name:'label'}, {data:'description', name:'description'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('speciality.create')}}';
                    }
                }
            ],
            responsive: {
