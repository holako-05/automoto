...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success) {
                    ...
                    window.location.replace("/marque");
                } else {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('marque.data') }}",
            columns: [{data: '',}, {data:'title', name:'title'}, {data:'value', name:'value'}, {data:'thumbnail', name:'thumbnail'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('marque.create')}}';
                    }
                }
            ],
            responsive: {
