...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('marque.store') }}">
            @csrf
            <div class="row g-3">
                   @can('marque.title.create')
   <div class="col-md-6">
   ...
   @endcan   @can('marque.value.create')
   <div class="col-md-6">
   ...
   @endcan   @can('marque.thumbnail.create')
   <div class="col-md-6">
       <label class="form-label" for="thumbnail">Image</label>
       <input type="text" name="thumbnail" id="thumbnail" class="form-control" placeholder="Image" value="{{ old('thumbnail') }}" />
       @error('thumbnail')
       <span class="helper-text text-danger">{{ $message }}</span>
       @enderror
   </div>
