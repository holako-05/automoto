...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('facture.data') }}",
            columns: [{data: '',}, {data:'code', name:'code'}, {data:'title', name:'title'}, {data:'prix_total', name:'prix_total'}, {data:'echeance', name:'echeance'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('facture_client.edit',1)}}';
                    }
                }
            ],
            responsive: {
