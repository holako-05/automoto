...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('categorie.store') }}">
            @csrf
            <div class="row g-3">
                   @can('categorie.name.create')
   <div class="col-md-6">
       <label class="form-label" for="name">Nom Catégorie</label>
       <input type="text" name="name" id="name" class="form-control" placeholder="Nom Catégorie" value="{{ old('name') }}" />
       @error('name')
