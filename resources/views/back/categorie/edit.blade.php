...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="py-3 mb-4">Gestion des categories</h4>
        </div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('categorie.index') }}">Liste des categories</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card mb-4">
        ...
        <form class="card-body" method="POST" action="{{ route('categorie.update', ['categorie' => $record->id]) }}">
            @csrf
            @method('Put')
            <div class="row g-3">
                   @can('categorie.name.update')
   <div class="col-md-6">
       <label class="form-label" for="name">Nom Catégorie</label>
       <input type="text" name="name" id="name" class="form-control" placeholder="Nom Catégorie" value="{{ old('name', $record->name) }}" />
       @error('name')
   ...
   @endcan
            ...
            <div class="pt-4 float-start">
                ...
                <a href="{{ route('categorie.index') }}" class="btn btn-label-secondary">Retour</a>
            </div>
        </form>
    </div>
</div>
