...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" method="POST" action="{{ route('reception.store') }}">
                @csrf
                <div class="row g-3">
                    @can('reception.received_date.create')
                        <div class="col-md-6">
                        ...
                        @endcan @can('reception.description.create')
                        <div class="col-md-6">
                                    ...
                                    <div class="row w-100 m-0 p-3">
                                        ...
                                        <div class="col-md-6 col-12 mb-md-0 mb-3">
                                            ...
                                            <input type="number" class="form-control invoice-item-qty" name="quantity"
                                                value="1" placeholder="1" min="1" max="300" />
                                        </div>
                                    </div>
                                    <div
