...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success) {
                    ...
                    window.location.replace("/reception_product");
                } else {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('reception_product.data') }}",
            columns: [{data: '',}, {data:'reception_id', name:'reception_id'}, {data:'product_id', name:'product_id'}, {data:'receiver_quantity', name:'receiver_quantity'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('reception_product.create')}}';
                    }
                }
            ],
            responsive: {
