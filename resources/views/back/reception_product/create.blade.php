...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" method="POST" action="{{ route('reception_product.store') }}">
                @csrf
                <div class="row g-3">
                    @can('reception_product.reception_id.create')
                        <div class="col-md-6">
                            ...
                            <select name="reception_id" id="reception_id" class="select2 form-control" data-allow-clear="true">
                                @foreach ($receptionRecords as $row)
                                    <option class="option" {{ $row->id == old('reception_id') ? 'selected' : '' }}
                        ...
                        @endcan @can('reception_product.product_id.create')
                        <div class="col-md-6">
                            ...
                            <select name="product_id" id="product_id" class="select2 form-control" data-allow-clear="true">
                                @foreach ($productRecords as $row)
                                    <option class="option" {{ $row->id == old('product_id') ? 'selected' : '' }}
                        ...
                        @endcan @can('reception_product.receiver_quantity.create')
                        <div class="col-md-6">
                            ...
                            <input type="text" name="receiver_quantity" id="receiver_quantity" class="form-control"
                                placeholder="Quantité réceptionné" value="{{ old('receiver_quantity') }}" />
