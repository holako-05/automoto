...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <div class="d-flex flex-column justify-content-center">
            <h4 class="py-3 mb-4">Gestion des vehicules</h4>
        </div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="{{ route('vehicule.index') }}">Liste des vehicules</a>
                    </li>
                </ol>
            </nav>
        </div>
...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('vehicule.data') }}",
            columns: [{data: '',}, {data:'client_id', name:'client_id'}, {data:'marque_id', name:'marque_id'}, {data:'modele_id', name:'modele_id'}, {data:'year', name:'year'}, {data:'fuelType', name:'fuelType'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('vehicule.create')}}';
                    }
                }
            ],
            responsive: {
