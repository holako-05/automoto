...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success) {
                    ...
                    window.location.replace("/facture_article");
                } else {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('facture_article.data') }}",
            columns: [{data: '',}, {data:'article', name:'article'}, {data:'facture_id', name:'facture_id'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('facture_article.create')}}';
                    }
                }
            ],
            responsive: {
