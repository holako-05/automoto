...
<script type="text/javascript">
    ...
    function suppRecord() {
        ...
        var dt_filter = dt_filter_table.DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('annee.data') }}",
            columns: [{data: '',}, {data:'year', name:'year'}, {data: 'action', name: 'action', orderable: false, searchable: false}],
            columnDefs: [{
                // For Responsive
                className: 'control',
                orderable: false,
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    {
                        window.location.href = '{{route('annee.create')}}';
                    }
                }
            ],
            responsive: {
