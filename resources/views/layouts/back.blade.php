            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admin') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">{{$apparence->label}}</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ in_array(Route::currentRouteName(), [$menu->page]) ? 'active open' : '' }}">
                        <a href="{{route($menu->page ?? 'admin')}}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-{{$menu->icon}}"></i>
                            <div class="text-truncate" data-i18n="{{$menu->titre}}">{{$menu->titre}}</div>
                        </a>
                    </li>
                    @endif
                    @else
                    @if($menu->ressource == "" || \Auth::user()::hasRessource($menu->ressource_name))
                    <li class="menu-item {{ in_array(Route::currentRouteName(), collect($subMenus)->pluck('page')->toArray()) ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ in_array(Route::currentRouteName(), [$subMenu->page]) ? 'active' : '' }}">
                                <a href="{{route($subMenu->page ?? 'admin')}}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-{{$subMenu->icon}}"></i>
                                    <div class="text-truncate" data-i18n="{{$subMenu->titre}}">{{$subMenu->titre}}</div>
                                </a>
                            </li>
                            @endif
                            @endforeach
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                                <a class="nav-link dropdown-toggle hide-arrow" onclick="checkForNewReservations(1)" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="{{ Auth::user()->photo ? '/uploads/photos/' . Auth::user()->photo : '/uploads/photos/default.png' }}" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{route('user.profil')}}">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-medium d-block">{{ Auth::user()->name ? Auth::user()->name : "" }} {{Auth::user()->first_name ? Auth::user()->first_name : "" }}</span>
